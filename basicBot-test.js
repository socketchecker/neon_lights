...
(function () {
    ...
    var botMaintainer = "Javascripto:"
    var botCreatorIDs = ["3851534", "10171579"];

    var basicBot = {
        version: "0.0.1",
        status: false,
        name: "Dack_Janiels_v2",
        loggedInID: null,
        scriptLink: "https://github.com/dansinge/neon_lights/blob/master/basicBot-test.js",
        cmdLink: "https://git.io/vofmh",
        chatLink: "https://rawgit.com/dansinge/neon_lights/master/lang/ltu.json",
        chat: null,
        loadChat: loadChat,
        ...
        eventDjadvance: function (obj) {
            ...
            if (basicBot.settings.songstats) {
                if (typeof basicBot.chat.songstatistics === "undefined") {
                    API.sendChat("/me " + lastplay.media.author + " - " + lastplay.media.title + ": " + lastplay.score.positive + ":thumbsup:/" + lastplay.score.grabs + ":green_heart:/" + lastplay.score.negative + ":thumbsdown:.")
                }
                else {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        $.get("https://rawgit.com/dansinge/neon_lights/master/lang/langIndex.json", function (json) {
                            ...
                            if (typeof link === "undefined") {
                                API.sendChat(subChat(basicBot.chat.langerror, {link: "https://git.io/vofY5"}));
                            }
                            else {
